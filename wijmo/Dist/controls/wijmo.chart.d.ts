...
declare module wijmo.chart {
    ...
    class FlexPie extends FlexChartBase {
        ...
        _drawSilce(engine: IRenderEngine, i: number, reversed: boolean, cx: number, cy: number, r: number, irad: number, angle: number, sweep: number): void;
...
declare module wijmo.chart {
    ...
    class Legend {
        ...
        _render(engine: IRenderEngine, pt: Point, pos: Position, w: number, h: number): any;

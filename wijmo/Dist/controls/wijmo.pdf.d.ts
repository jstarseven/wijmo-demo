...
interface _IPdfKitDocument {
    ...
    textAndMeasure(text: string, x: number, y: number, options: _IPdfKitTextOptions, measureOnly?: boolean): _IPdfKitTextSize;
...
interface _IPdfKitHeightOfStringOptions extends _IPdfKitTextOptions {
    lastLineExternalLeadingGap?: boolean;
}
